...
import pageObjects.liveguru.admin.DashboardPageObject;
...
import pageUI.liveguru.user.RegisterPageUI;
...
//	}
	...
	public String getAttribute(WebDriver driver, String locator, String attributeName, String... values) {
	...
	public Float getGrandTotalValue(WebDriver driver) {
		waitForElementsVisible(driver, AbstractPageUI.GRANDTOTAL_VALUE);
		String [] grandTotal = getElementText(driver, AbstractPageUI.GRANDTOTAL_VALUE).split("$");
		return Float.parseFloat(grandTotal[1]);
	}
	...
	public void selectValueInDropdow(WebDriver driver, String locator, String selectedvalue, String... values) {
	...
	public boolean isSuccessMessageDisplayed(WebDriver driver, String successMessage) {
		waitForElementVisible(driver, AbstractPageUI.DYNAMIC_SUCCESS_TEXT, successMessage);
		return isElementDisplayed(driver, AbstractPageUI.DYNAMIC_SUCCESS_TEXT, successMessage);
	}

	public boolean isProductNameDisplayed(WebDriver driver, String productName) {
		waitForElementVisible(driver, AbstractPageUI.DYNAMIC_PRODUCT_NAME, productName);
		return isElementDisplayed(driver, AbstractPageUI.DYNAMIC_PRODUCT_NAME, productName);
	}
...
//	}
	...
	public AbstractPage openTabByTabName(WebDriver driver, String tabName) {
	...
	public void clickToProductNameLink(WebDriver driver, String productName) {
		waitForElementClickable(driver, AbstractPageUI.DYNAMIC_PRODUCT_NAME_LINK, productName);
		clickToElement(driver, AbstractPageUI.DYNAMIC_PRODUCT_NAME_LINK, productName);

	}

	public void clickToAddToCartButton(WebDriver driver, String productName) {
		waitForElementClickable(driver, AbstractPageUI.ADD_TO_CART_BUTTON_IN_lIST_PAGE, productName);
		clickToElement(driver, AbstractPageUI.ADD_TO_CART_BUTTON_IN_lIST_PAGE, productName);

	}

	public void clickToAddToCompareOrWishListByProductName(WebDriver driver, String productName, String buttonName) {
		waitForElementClickable(driver, AbstractPageUI.ADD_TO_COMPARE_OR_WISHLIST_BUTTON, productName, buttonName);
		clickToElement(driver, AbstractPageUI.ADD_TO_COMPARE_OR_WISHLIST_BUTTON, productName, buttonName);

	}

	public void selectItemInDynamicDropdowList(WebDriver driver, String dropdownName, String selectedItem) {
		selectValueInDropdow(driver, AbstractPageUI.DYNAMIC_DEFAULT_DROPDOWN_LIST, selectedItem, dropdownName);
	}
...
//	}
	...
	public HomeUserPageObject OpenEndUserPage(WebDriver driver) {
		openURL(driver, GlobalConstants.LIVEGURU_USER_URL);
...
//	}
	...
	public void inputToDynamicTextarea(WebDriver driver, String nameAttributeValue, String inputValue) {
		...
		sendkeyToElement(driver, AbstractPageUI.DYNAMIC_TEXTAREA, inputValue, nameAttributeValue);
	}

	public void clickToDynamicButton(WebDriver driver, String buttonTitleValue) {
		waitForElementClickable(driver, AbstractPageUI.DYNAMIC_BUTTON, buttonTitleValue);
		clickToElement(driver, AbstractPageUI.DYNAMIC_BUTTON, buttonTitleValue);
...
//
	public void clickToDynamicLink(WebDriver driver, String linkName) {
		waitForElementClickable(driver, AbstractPageUI.DYNAMIC_LINK_TEXT, linkName);
		clickToElement(driver, AbstractPageUI.DYNAMIC_LINK_TEXT, linkName);
	}
//
...
//	}
	...
	public void clickToDynamicLinkInAccountHeader(WebDriver driver, String linkName) {
		waitForElementClickable(driver, AbstractPageUI.DYNAMIC_LINK_IN_ACCOUNT_HEADER, linkName);
		clickToElement(driver, AbstractPageUI.DYNAMIC_LINK_IN_ACCOUNT_HEADER, linkName);
